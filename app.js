...
app.use((req, res, next) => {
    if (req.method === 'GET' && !req.url.startsWith('/listings/') && !req.url.startsWith('/')) { // Adjust the condition as needed
        const filePath = path.join(__dirname, 'public', req.url);
        if (!fs.existsSync(filePath)) { // Use fs.existsSync
...
app.put("/listings/:id", async (req, res) => {
    console.log(`PUT /listings/:id - req.path: ${req.path}, req.params:`, req.params);
    let { id } = req.params;
...
app.delete("/listings/:id", async (req, res) => {
    console.log(`DELETE /listings/:id - req.path: ${req.path}, req.params:`, req.params);
    let { id } = req.params;
